...
import torch
from diff_gaussian_yang_rasterization import (
...
from .decoder import DecoderOutputCUDACfg
...
def render_cuda(
    ...
    # return DecoderOutputCUDACfg(torch.stack(all_images), torch.stack(all_alphas))
    return DecoderOutputCUDACfg(torch.stack(all_images), torch.stack(all_depths), torch.stack(all_alphas))
