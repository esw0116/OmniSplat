...
def get_omni_world_rays(
    ...
    # )
    if omni_mode == 'omni':
        directions = omni_to_3d(coordinates, 2, 2)
    elif omni_mode == 'yin':
        directions = yin_to_3d(coordinates, 2, 2)
    elif omni_mode == 'yang':
        directions = yang_to_3d(coordinates, 2, 2)
    elif omni_mode == 'yang90':
        directions = yang90_to_3d(coordinates, 2, 2)
    else:
        raise NotImplementedError('omnidirectional mode should be one of [omni, yin, yang]')
