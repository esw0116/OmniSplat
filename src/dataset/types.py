...
class BatchedViews(TypedDict, total=False):
    ...
    image_yin: Float[Tensor, "batch _ _ _ _"] | None
    image_yang: Float[Tensor, "batch _ _ _ _"] | None
    intrinsics_yin: Float[Tensor, "batch _ 3 3"] | None
    intrinsics_yang: Float[Tensor, "batch _ 3 3"] | None
