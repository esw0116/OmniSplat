...
class DatasetRE10k(IterableDataset):
    ...
    def __init__(
        ...
        if cfg.far != -1:
            self.far = cfg.far
        if cfg.target_shape == None:
            cfg.target_shape = cfg.image_shape
    ...
    def __iter__(self):
        ...
        for chunk_path in self.chunks:
            ...
            for run_idx in range(int(times_per_scene * len(chunk))):
                ...
                # target_names = [example["timestamps"][index.item()] for index in target_indices]
                ...
                example = {
                    ...
                    "target": {
                        ...
                        "image_shape": tuple(self.cfg.target_shape),
                ...
                yield apply_crop_shim(example, tuple(self.cfg.image_shape), tuple(self.cfg.target_shape))
